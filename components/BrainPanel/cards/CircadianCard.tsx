    ...
    <div className="bg-white dark:bg-zinc-800 rounded-xl p-4">
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          <div className="text-gray-500 dark:text-zinc-500 text-[13px] uppercase">Circadian</div>
          <div className="text-lg font-semibold text-cyan-400">{currentTime}</div>
          <div className="text-[13px] text-gray-500 dark:text-zinc-500">{circadian}</div>
          <div className="flex items-center gap-2 mt-1">
            <span className="text-[13px] text-gray-500 dark:text-zinc-500">Sleep</span>
            ...
            <span className="text-[13px] text-gray-500 dark:text-zinc-500">Awake</span>
          </div>
        </div>
      </div>
    </div>
