  ...
  return (
    <>
      ...
      <aside className={`border-r border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 flex flex-col shrink-0 transition-all duration-300 select-text max-sm:fixed max-sm:left-0 max-sm:top-0 max-sm:h-full max-sm:z-50 ${mobileOpen? "max-sm:w-56" : "max-sm:w-0 max-sm:overflow-hidden"} ${collapsed? "w-16" : "w-56"}`}>
        ...
        <div className="px-2 py-3 border-t border-zinc-100 dark:border-zinc-800 space-y-1"><div className="px-3 py-1 text-[10px] font-semibold text-zinc-400 dark:text-zinc-500 uppercase tracking-wider">DEPLOYMENTS</div><a href="https://vercel.com/yonjan-ventures/fast-mind/deployments" target="_blank" className="flex items-center gap-2 px-3 py-1.5 text-xs text-zinc-500 hover:text-cyan-600 dark:hover:text-cyan-400 transition rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>Vercel (Production)</a><a href="https://github.com/arjunyonjan/fast-mind" target="_blank" className="flex items-center gap-2 px-3 py-1.5 text-xs text-zinc-500 hover:text-cyan-600 dark:hover:text-cyan-400 transition rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800"><svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12c0 4.42 2.87 8.17 6.84 9.49.5.09.68-.21.68-.48 0-.24-.01-.88-.01-1.72-2.78.6-3.37-1.34-3.37-1.34-.46-1.16-1.11-1.47-1.11-1.47-.91-.62.07-.61.07-.61 1.01.07 1.54 1.04 1.54 1.04.9 1.54 2.36 1.09 2.93.84.09-.65.35-1.09.64-1.34-2.22-.25-4.55-1.11-4.55-4.95 0-1.09.39-1.98 1.03-2.68-.1-.25-.45-1.27.1-2.64 0 0 .84-.27 2.75 1.02.8-.22 1.65-.33 2.5-.33.85 0 1.7.11 2.5.33 1.91-1.29 2.75-1.02 2.75-1.02.55 1.37.2 2.39.1 2.64.64.7 1.03 1.59 1.03 2.68 0 3.84-2.34 4.7-4.56 4.95.36.31.68.92.68 1.85 0 1.34-.01 2.42-.01 2.75 0 .27.18.58.69.48C19.13 20.17 22 16.42 22 12c0-5.52-4.48-10-10-10z"/></svg>GitHub</a>
