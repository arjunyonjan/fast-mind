...
export default function BrainPanel() {
  ...
  return (<>
    ...
    {open && (<div className="fixed inset-0 z-[9999] flex items-start justify-end pointer-events-none"><div style={{ width: panelWidth }} className="pointer-events-auto h-full bg-zinc-900/95 border-l border-zinc-800 shadow-2xl flex flex-col text-base font-sans text-zinc-300">
