...
export default function BrainPanel() {
  ...
  return (<>
    ...
    {open && (<div className="fixed inset-0 z-[9999] flex items-start justify-end pointer-events-none"><div style={{ width: panelWidth }} className="relative pointer-events-auto h-full bg-zinc-900/95 border-l border-zinc-800 shadow-2xl flex flex-col text-base font-sans text-zinc-300">
      <div className="flex items-center justify-between p-5 pb-2 shrink-0"><h2 className="text-sm font-semibold text-zinc-200 flex items-center gap-2"><Brain size={16} className="text-purple-400" /> YOUR BRAIN<span className="text-[9px] font-normal text-zinc-500 ml-1">— powered by</span><span className="text-[9px] font-semibold bg-gradient-to-r from-amber-400 to-orange-500 bg-clip-text text-transparent ml-0.5">Buddha Engine</span></h2><button onClick={() => toggleOpen(false)} className="text-zinc-500 hover:text-white"><X size={14} /></button></div>
