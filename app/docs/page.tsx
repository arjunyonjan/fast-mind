    ...
    <div className="min-h-screen bg-white dark:bg-zinc-950">
      <div className="max-w-4xl mx-auto px-6 py-10">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-3xl font-bold text-zinc-900 dark:text-white">Documentation</h1>
        </div>
        <div className="grid gap-4 sm:grid-cols-2">
          <Link href="/docs/brain-panel" className="group p-5 border border-zinc-200 dark:border-zinc-800 rounded-xl hover:border-cyan-500 transition">
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400">Modular React components, hooks, metrics calculation flow, and real-time brain health tracking.</p>
          </Link>
