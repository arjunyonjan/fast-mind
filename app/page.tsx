  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <div className="text-center mb-12">
        <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 shadow-lg mb-4"><span className="text-4xl animate-pulse">⚡</span></div>
        <h1 className="text-5xl font-bold bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent">FastMind</h1>
        <p className="text-gray-500 mt-2">Notion-grade editor with rich formatting, tables, and code blocks</p>
      ...
      <div className="space-y-3">
        ...
        {documents.length === 0 ? <div className="text-center py-12 bg-gray-50 rounded-xl"><p className="text-gray-400">No documents yet. Create your first one!</p></div> :
          documents.map((doc) => (
